...
var layout = {
  ...
  hideFrom: {
    ...
    transform: (value, theme2) => {
      var _a8, _b5;
      const { minWQuery = value } = (_b5 = (_a8 = theme2.__breakpoints) == null ? void 0 : _a8.get(value)) != null ? _b5 : {};
      return {
  ...
  hideBelow: {
    ...
    transform: (value, theme2) => {
      var _a8, _b5;
      const { maxWQuery = value } = (_b5 = (_a8 = theme2.__breakpoints) == null ? void 0 : _a8.get(value)) != null ? _b5 : {};
      return {
...
var getActiveElement2 = function(inDocument) {
  ...
  return activeElement.shadowRoot ? getActiveElement2(activeElement.shadowRoot) : activeElement instanceof HTMLIFrameElement && ((_a8 = activeElement.contentWindow) === null || _a8 === void 0 ? void 0 : _a8.document) ? getActiveElement2(activeElement.contentWindow.document) : activeElement;
};
